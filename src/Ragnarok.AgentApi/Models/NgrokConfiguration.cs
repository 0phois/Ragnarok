...
namespace Ragnarok.AgentApi.Models
{
    ...
    public class NgrokConfiguration
    {
        ...
        /// <summary>
        /// Specifies the ngrok API key used to connect to the ngrok API
        /// </summary>
        ...
        public ConsoleOptions ConsoleUI { get; set; } = ConsoleOptions.@false;
        ...
        public NgrokConfigLogLevel LogLevel { get; set; } = NgrokConfigLogLevel.debug;

        /// <summary>
        /// Format of written log records
        /// </summary>
        [YamlMember(Alias = "log_format")]
        public NgrokLogFormat LogFormat { get; set; } = NgrokLogFormat.json;

        /// <summary>
        /// Write logs to this target destination
        /// </summary>
        [YamlMember(Alias = "log")]
        public string Log { get; set; } = "stdout";
